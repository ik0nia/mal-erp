                    ...
                    <tbody>
                        @foreach($rows as $row)
                            <tr>
                                ...
                                <td class="so-sku" onclick="navigator.clipboard.writeText('{{ $row->sku }}').then(()=>{this.style.color='#22c55e';setTimeout(()=>this.style.color='',1000)})" title="Click pentru a copia SKU">{{ $row->sku }}</td>
                                <td>
