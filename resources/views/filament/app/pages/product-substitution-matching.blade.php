<x-filament-panels::page>
    ...
    <div class="grid grid-cols-7 gap-3 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 text-center">
            <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format($stats['totalSource']) }}</div>
            <div class="text-xs text-gray-500 mt-1">Produse totale</div>
        </div>

        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 text-center">
            <div class="text-2xl font-bold text-gray-400">{{ number_format($stats['unprocessed']) }}</div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 text-center">
            <div class="text-2xl font-bold text-gray-400">{{ number_format($stats['noMatch']) }}</div>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 mb-6 text-sm text-blue-700 dark:text-blue-300">
        ...
        Agenții vor căuta automat echivalente Toya pentru cele {{ number_format($stats['totalSource']) }} produse existente.
    </div>
    @endif
