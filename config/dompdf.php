...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var bool
         */
        'enable_javascript' => false, // disabled — internal PDFs don't need PDF-JS
         ...
         * @var bool
         */
        'enable_remote' => true, // pozele produse Toya (pim.toya.pl) necesare în PDF propuneri

        /**
         * Enable CSS float
         *
         * Allows CSS float layout to work correctly in rendered PDFs.
         *
         * @var bool
         */
