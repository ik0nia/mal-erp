...
class BiMarginTrendChartWidget extends ChartWidget
{
    protected ?string $heading = 'Evoluție marjă brută';
    ...
    protected function getData(): array
    {
        ...
        return [
            'datasets' => [
                [
                    'label'            => 'Valoare stoc la cost (RON)',
                    'data'             => $rows->map(fn ($r) => round((float) ($r->inventory_value_cost_closing_total ?? 0), 0))->toArray(),
                ...
                [
                    'label'            => 'Marjă brută %',
                    'data'             => $rows->map(fn ($r) => round((float) ($r->gross_margin_pct ?? 0), 2))->toArray(),
