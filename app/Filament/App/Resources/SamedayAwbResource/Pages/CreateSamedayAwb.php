...
class CreateSamedayAwb extends CreateRecord
{
    ...
    public function mount(): void
    {
        ...
        $locationId = SamedayAwbResource::currentUserLocationId();
        $countyId = SamedayAwbResource::resolveCountyIdFromText($locationId, request()->string('recipient_county')->toString());
        if ($countyId) {
            $prefill['recipient_county_id'] = $countyId;
            $cityId = SamedayAwbResource::resolveCityIdFromText($locationId, $countyId, request()->string('recipient_city')->toString());
            if ($cityId) {
